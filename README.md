...
> **Vibecoded with [Claude Code](https://claude.ai/code).** This entire application was built through AI-assisted development. No warranty. Use at your own risk.
...
✓ **Reactions** - Emoji reactions on comments and posts (♥ 👍 💡 😄)
✓ **Rate limiting** - Prevent abuse (5 comments/hour per IP)
✓ **Recent comments** - Site-wide recent comments widget
✓ **Closed comments** - Display existing comments without allowing new ones
✓ **Hugo integration** - Ready-to-use partials and shortcodes
✓ **Import tools** - Migrate from Disqus, TalkYard, WordPress (WXR)
✓ **Analytics dashboard** - Charts for comment volume, top posts, activity patterns
